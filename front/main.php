...
<div class="tags">
    <div class='tag active' data-sec="sec1">健康新知</div>
    <div class='tag' data-sec="sec2">菸害防治</div>
    <div class='tag' data-sec="sec3">癌症防治</div>
    <div class='tag' data-sec="sec4">慢性病防治</div>
</div>
<artical>
    <section id="sec1" class="d-block">
        <br>
        <h2>健康新知</h2>
        <br>
        <pre>
