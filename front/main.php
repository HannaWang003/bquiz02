...
<div style="display:flex;margin:3vh 0 0 1px">
...
<div class="sec" id="sec2" style="display:none">
    <h2>菸害防治</h2>
    <pre>
    菸害防治法規
...
<div class="sec" id="sec3" style="display:none">
    <h2>癌症防治</h2>
    <pre>
    降低罹癌風險 建構健康生活型態
...
<div class="sec" id="sec4" style="display:none">
    <h2>慢性病防治</h2>
    <pre>
    長期憋尿 泌尿系統問題多
    資料來源：中央健康保險局雙月刊第98期
